...
public class KnowledgeBaseService {
        ...
        private final List<Entry> entries = Arrays.asList(
                        ...
                        // ── fornecer link da web caso peçam ───────────────────────────────────────

                        new Entry(
                                        "Voce pode acessar a versao web do IntegraKids pelo link:\n" +
                                                        "https://jornada-da-inclusao.web.app\n\n" +
                                                        "Basta abrir no navegador e fazer login para utilizar a plataforma!",
                                        "link do site", "link da plataforma", "site do app", "site integrakids",
                                        "acessar pelo navegador", "versao web link", "me passa o site",
                                        "qual o site", "url do site", "endereco web", "link web"),

                        // ── Mascote do Projeto ─────────────────────────────────────────────

                        new Entry(
                                        "O mascote do projeto se chama Rigel (A estrela mais brilhante de Orion.) 😊 Ele representa o aprendizado, a criatividade e a inclusao de forma divertida, aproximando as criancas da plataforma.",
                                        "mascote", "quem e o mascote", "nome do mascote", "personagem do app",
                                        "boneco do app", "quem e esse personagem", "quem e integra kids"),
                        ...
                        new Entry(
                                        "O mascote foi criado para tornar o ambiente mais amigavel e acolhedor para as criancas. Personagens visuais ajudam no engajamento e deixam a experiencia mais divertida.",
                                        "por que tem mascote", "pra que serve o mascote", "qual funcao do mascote",
                                        "por que criaram o personagem", "motivo do mascote"),

                        new Entry(
                                        "Na versao mobile, o mascote participa bastante da experiencia visual, ajudando a deixar o aplicativo mais leve, infantil e convidativo para o publico infantil.",
                                        "mascote no mobile", "personagem no celular", "mascote no app",
                                        "onde aparece o mascote", "mascote aparece no aplicativo"),

                        new Entry(
                                        "Criancas costumam se conectar melhor com elementos visuais e personagens. O mascote ajuda a criar familiaridade, conforto e interesse em continuar usando o app.",
                                        "como ajuda as criancas", "mascote ajuda crianca", "por que criancas gostam",
                                        "qual impacto do mascote", "como deixa amigavel"),

                        new Entry(
                                        "O mascote representa a ideia de aprender como uma aventura 😊 Ele transmite incentivo, curiosidade e desenvolvimento de forma positiva.",
                                        "o que o mascote representa", "significado do mascote",
                                        "qual mensagem do mascote", "simbolo do personagem"),

                        new Entry(
                                        "Sim! O mascote faz parte da identidade visual do IntegraKids e ajuda a tornar o projeto mais marcante e reconhecivel.",
                                        "identidade visual", "logo com personagem", "personagem da marca",
                                        "faz parte da marca", "representa a marca"),
